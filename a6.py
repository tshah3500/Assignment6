...
class BayesClassifier:
    ...
    def classify(self, text: str) -> str:
        ...
        print("pos_prob is:" + str(pos_prob))
        print("neg_prob is:" + str(neg_prob))
...
if __name__ == "__main__":
    ...
    print("\nTarun's predicted positive sentences:")
    print(b.classify('Chipotle is an amazing resteraunt and much better than Taco Bell'))
    print(b.classify("This might be the best burrito I've ever had!"))
    print(b.classify("Don't you just love chicken noodle soup?"))
    print("\nTarun's predicted negative sentences:")
